export default function WasteInfoBox() {
  return (
    <section className="bg-gradient-to-br from-[#0f172a]/80 to-[#1e293b]/80 backdrop-blur-sm border border-cyan-500/30 text-white rounded-2xl shadow-xl px-5 py-6 sm:px-8 sm:py-10 space-y-5 sm:space-y-6 break-keep">
      ...
      <ul className="list-disc list-outside space-y-2 text-sm sm:text-base text-slate-100 marker:text-cyan-400 pl-5 sm:pl-6">
