export default function WasteInfoBox() {
  return (
    <div className="bg-[#0f172a]/80 text-blue-100 border-l-4 border-cyan-300 p-6 rounded-lg shadow mb-10">
      <h2 className="text-4xl text-white font-semibold mb-2">대형폐기물이란?</h2>
