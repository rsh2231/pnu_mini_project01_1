...
export default function MainSection() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#1e3a8a] px-4 py-12 sm:py-16 text-white text-center shadow-lg space-y-6 sm:space-y-8">
      ...
      <p className="text-sm sm:text-base text-gray-200 max-w-full sm:max-w-xl leading-relaxed mx-auto px-2 break-keep">
        폐기물 이미지를 업로드하면 종류를 자동 분류하고,<br />지자체 신고와 결제를 간편하게 처리합니다.
      </p>
      ...
      {loginInfo.isLogin === "logged-in" ? (
        ...
        <p className="text-xs sm:text-sm text-gray-400 px-4 break-keep">
