      ...
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="grid gap-y-10 md:grid-cols-3 md:gap-8">
          ...
          <div className="bg-white p-6 md:p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3">AI 기반 자동 분류</h3>
          ...
          <div className="bg-white p-6 md:p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl md:text-2xl font-bold mb-3">간편 신고 및 결제</h3>
            <p className="text-gray-600 text-sm md:text-base">
          ...
          {/* Feature 3 */}
          <div className="bg-white p-6 md:p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            <div className="text-3xl md:text-4xl mb-4 text-orange-500">🤝</div>
            <h3 className="text-xl md:text-2xl font-bold mb-3">대형 폐기물 나눔</h3>
            <p className="text-gray-600 text-sm md:text-base">
